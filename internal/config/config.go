...
type SettingMeta struct {
	...
	Default         string
	Section         string // essential | merchants | apis | advanced
}

var AppSettings = []SettingMeta{
	{"WEB_ADMIN_PASSWORD", "Web admin password", true, true, "", "essential"},
	{"DISCORD_BOT_TOKEN", "Discord bot token", true, true, "", "advanced"},
	{"DISCORD_CHANNEL_ID", "Discord channel ID", false, true, "", "advanced"},
	{"REQUEST_TIMEOUT_SECONDS", "Request timeout seconds", false, true, "30", "advanced"},
	{"USER_AGENT", "HTTP user agent", false, true, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36", "advanced"},
	{"DISKPRICES_URL", "DiskPrices URL", false, true, "https://diskprices.com/?locale=fr", "apis"},
	{"PRICEPERGIG_ENABLED", "PricePerGig enabled", false, true, "true", "apis"},
	{"PRICEPERGIG_API_URL", "PricePerGig API URL", false, true, "https://api.pricepergig.com/drives", "apis"},
	{"PRICEPERGIG_MARKET", "PricePerGig market", false, true, "amazon.fr", "apis"},
	{"PRICEPERTB_URLS", "PricePerTB URLs", false, true, "https://pricepertb.com/fr", "apis"},
	{"DEALABS_RSS_URLS", "Dealabs RSS URLs", false, true, "", "apis"},
	{"IDEALO_FEED_URLS", "Idealo feed URLs", false, true, "", "apis"},
	{"LEDENICHEUR_FEED_URLS", "leDenicheur feed URLs", false, true, "", "apis"},
	{"LEBONCOIN_FEED_URLS", "leboncoin feed URLs", false, true, "", "apis"},
	{"KEEPA_API_KEY", "Keepa API key", true, true, "", "apis"},
	{"KEEPA_ASINS", "Keepa ASINs", false, true, "", "apis"},
	{"KEEPA_DOMAIN", "Keepa Amazon domain (1=com,2=uk,3=de,4=fr)", false, true, "4", "apis"},
	{"EBAY_CLIENT_ID", "eBay client ID", false, true, "", "apis"},
	{"EBAY_CLIENT_SECRET", "eBay client secret", true, true, "", "apis"},
	{"EBAY_SEARCH_QUERIES", "eBay search queries", false, true, "", "apis"},
	{"EBAY_MARKETPLACES", "eBay marketplaces (CSV: EBAY_FR, EBAY_DE, EBAY_IT, EBAY_ES)", false, true, "EBAY_FR", "apis"},
	{"KEEPA_DOMAINS", "Keepa domains (CSV: 3=DE, 4=FR, 6=IT, 7=ES)", false, true, "", "apis"},
	{"MINDFACTORY_URLS", "Mindfactory URLs (CSV)", false, true, "", "merchants"},
	{"ALTERNATE_URLS", "Alternate France URLs (CSV)", false, true, "https://www.alternate.fr/listing.xhtml?q=hdd,https://www.alternate.fr/listing.xhtml?q=ssd", "merchants"},
	{"COMPUTERUNIVERSE_URLS", "Computeruniverse URLs (CSV)", false, true, "", "merchants"},
	{"PROSHOP_URLS", "ProShop URLs (CSV)", false, true, "", "merchants"},
	{"GEIZHALS_URLS", "Geizhals URLs (CSV)", false, true, "", "merchants"},
	{"LDLC_URLS", "LDLC URLs (CSV)", false, true, "https://www.ldlc.com/recherche/disque+dur/", "merchants"},
	{"TOPACHAT_URLS", "TopAchat URLs (CSV)", false, true, "https://www.topachat.com/pages/produits_cat_est_micro_puis_rubrique_est_w_ssd.html", "merchants"},
	{"GROSBILL_URLS", "Grosbill URLs (CSV)", false, true, "https://www.grosbill.com/disque-ssd-49.aspx,https://www.grosbill.com/disque-dur-3-5-interne-3.aspx", "merchants"},
	{"FNAC_URLS", "Fnac URLs (CSV)", false, true, "https://www.fnac.com/Disques-durs-internes/s21528,https://www.fnac.com/SSD/s41228", "merchants"},
	{"BOULANGER_URLS", "Boulanger URLs (CSV)", false, true, "https://www.boulanger.com/c/disque-dur-interne,https://www.boulanger.com/c/ssd", "merchants"},
	{"CDISCOUNT_URLS", "Cdiscount URLs (CSV)", false, true, "https://www.cdiscount.com/informatique/disques-durs-internes/l-1072201.html,https://www.cdiscount.com/informatique/ssd/l-1072208.html", "merchants"},
	{"RAKUTEN_URLS", "Rakuten FR URLs (CSV)", false, true, "", "merchants"},
	{"RUEDUCOMMERCE_URLS", "Rue du Commerce URLs (CSV)", false, true, "https://www.rueducommerce.fr/recherche/disque-dur-interne/", "merchants"},
	{"BACKMARKET_URLS", "Back Market URLs (CSV)", false, true, "", "merchants"},
	{"DARTY_URLS", "Darty storage URLs (CSV)", false, true, "https://www.darty.com/nav/q/informatique-disque-dur-ssd.html", "merchants"},
	{"MATERIEL_URLS", "Materiel.net storage URLs (CSV)", false, true, "https://www.materiel.net/disque-dur-interne/l430/,https://www.materiel.net/disque-ssd/l429/", "merchants"},
	{"CYBERTEK_URLS", "Cybertek storage URLs (CSV)", false, true, "https://www.cybertek.fr/disque-ssd-49.aspx,https://www.cybertek.fr/disque-dur-3-5-interne-3.aspx", "merchants"},
	{"CORSAIR_URLS", "Corsair France storage URLs (CSV)", false, true, "https://www.corsair.com/fr/fr/c/data-storage", "merchants"},
	{"PCCOMPONENTES_URLS", "PCComponentes France storage URLs (CSV)", false, true, "https://www.pccomponentes.fr/categories/disques-durs/disque-ssd", "merchants"},
	{"TOPBIZ_URLS", "Topbiz storage URLs (CSV)", false, true, "https://www.topbiz.fr/95-disques-durs-ssd,https://www.topbiz.fr/96-disques-durs-internes", "merchants"},
	{"SOURCE_HEADLESS_FALLBACK", "Headless fallback", false, true, "true", "essential"},
	{"BYPARR_URL", "Byparr URL", false, true, "http://byparr:8191", "essential"},
	{"NOTIFICATION_PRICE_DROP_PCT", "Notification price drop percent", false, true, "2.0", "essential"},
	{"SCRAPE_INTERVAL_CRON", "Scan interval (@every 4h)", false, true, "@every 4h", "essential"},
	{"RETRY_MAX_ATTEMPTS", "Retry max attempts", false, false, "3", "advanced"},
	{"RETRY_BASE_DELAY_SECONDS", "Retry base delay seconds", false, false, "0.5", "advanced"},
	{"RETRY_MAX_DELAY_SECONDS", "Retry max delay seconds", false, false, "30", "advanced"},
	{"ENABLED_SOURCES", "Enabled sources (comma-separated)", false, false, "", "essential"},
	{"HEADERS_EXTRA", "Extra HTTP headers (JSON)", false, true, "", "advanced"},
	{"USER_AGENT_POOL", "User agent pool (comma-separated)", false, true, "", "advanced"},
	{"BLOCKED_DETECTION_KEYWORDS", "Blocked detection keywords", false, false, "cf-browser-verification,Just a moment...,Checking your browser,Enable JavaScript,Access Denied,captcha,403 Forbidden", "advanced"},
	{"CIRCUIT_BREAKER_ENABLED", "Circuit breaker enabled", false, false, "true", "advanced"},
	{"CIRCUIT_BREAKER_THRESHOLD", "Circuit breaker failure threshold", false, false, "5", "advanced"},
	{"CIRCUIT_BREAKER_TIMEOUT_SECONDS", "Circuit breaker open timeout seconds", false, false, "60", "advanced"},
	{"PER_REQUEST_TIMEOUT_SECONDS", "Per-request timeout seconds", false, false, "10", "advanced"},
	{"SOURCE_HEALTH_STREAK_THRESHOLD", "Consecutive zero-deal scans before a source is flagged", false, false, "3", "advanced"},
	{"BACK_IN_STOCK_HOURS", "Hours of absence after which a returning deal is flagged as back-in-stock", false, false, "48", "advanced"},
}
...
// FrenchMerchantNames lists FR retail scrapers shown as on/off toggles on Sites.
var FrenchMerchantNames = []string{
	"alternate", "boulanger", "cdiscount", "corsair", "cybertek", "darty",
	"fnac", "grosbill", "ldlc", "materiel", "pccomponentes", "rueducommerce",
	"topachat", "topbiz",
}

// ConfigSectionOrder is the display order for grouped configuration.
var ConfigSectionOrder = []string{"essential", "merchants", "apis", "advanced"}
