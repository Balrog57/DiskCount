...
// ⚡ Bolt optimization: hoisted lowercase knownBrands to a package-level var
// initialized in init() so inferBrand does not allocate new lowercase strings
// repeatedly on every match loop iteration.
