...
//
// ⚡ Bolt optimization: Pre-compute lowercased brand names at startup.
// Previously `strings.ToLower(b)` was called in a loop for every known brand,
// allocating dozens of short-lived strings per deal processed. Using a package-level
// slice avoids these allocations.
