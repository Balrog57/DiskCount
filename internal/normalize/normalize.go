...
//
// ⚡ Bolt optimization: Pre-computing the lowercase brand names avoids calling
// strings.ToLower repeatedly inside the loop for every deal, significantly
// reducing allocation overhead in the hot path.
